...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_match'] = 0  # A: Number of Correct Dog matches
    results_stats_dic['n_correct_dogs'] = 0  # A: Number of Correct Dog matches
    results_stats_dic['n_correct_notdogs'] = 0  # C: Number of Correct Non-Dog matches
    results_stats_dic['n_correct_breed'] = 0  # E: Number of Correct Breed matches
